...
@Autonomous(name= "Blue_Left_Pos_2", group = "blueLeft")
@Disabled

public class Blue_Left_Pos_2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (color.blue() > color.red() && color.blue() > color.green()) {
                ...
                posStrafeLeft(1000, 1000);

                posForward(1000, 2500);

                posStrafeLeft(500, 1000);
                ...
                if (color.blue() > color.red() && color.blue() > color.green()) {
                    ...
                    if (color.blue() > color.red() && color.blue() > color.green()) {
                        ...
                        posStrafeLeft(800, 1300);

                        posForward(900, 1600);

                        posStrafeLeft(500, 1300);
