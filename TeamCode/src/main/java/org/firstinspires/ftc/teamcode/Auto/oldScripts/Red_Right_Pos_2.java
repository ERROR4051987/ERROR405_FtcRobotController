...
@Autonomous(name= "Red_Right_Pos_2", group = "redRight")
@Disabled

public class Red_Right_Pos_2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (color2.red() > color2.blue() && color2.red() > color2.green()) {
                ...
                posStrafeRight(1000, 700);

                posForward(1000, 1400);

                posStrafeRight(1000, 1500);
                ...
                if (color2.red() > color2.blue() && color2.red() > color2.green()) {
                    ...
                    if (color2.red() > color2.blue() && color2.red() > color2.green()) {
                        ...
                        posStrafeRight(800, 800);

                        posForward(800, 1800);

                        posStrafeRight(800, 2000);
