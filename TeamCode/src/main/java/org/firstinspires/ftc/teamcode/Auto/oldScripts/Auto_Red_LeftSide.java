...
@Autonomous (name= "Auto_Red_LeftSide", group = "Autonomous")
@Disabled

public class Auto_Red_LeftSide extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (drive_Ready == true) {
                ...
                strafe(0.4, -0.4, 0.4, -0.4, 0.25, 0);
                //       left right time intake
                drive(0.6, 0.6, 2.5, 0);
                //          Bl    Fl   Fr    Br  Time  Intake
                strafe(0.4, -0.4, 0.4, -0.4, 0.1, 0);
                //       left right time intake
                drive(0.6, 0.6, 0.7, 0);
                //       left right time intake
                drive(0, 0, 0.5, -1.0);
